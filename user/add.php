...
if (isset($_GET['id'])) {
 ...
 $requits="SELECT * FROM contacts WHERE Id_contacts ='$id' ";
  ...
  ?>
      ...
      <form action="<?php  
  if(isset($_GET['id'])) {
    echo './file_update.php'; 
  } else {
    echo '../phpFiles/page.php';
  } 
?>"   method="POST" class="row g-3 mt-4 mx-1" style="width: 90%; ">
        <div class="col-md-6">
            <label for="FirstName"  class="form-label">Full Name</label>
          <input id="FirstName" value=" <?php  if(isset($_GET['id'])){
               echo $Fullname; 
              }  ?> " type="text" name="Nom"  class="form-control" placeholder="ex : Mohamed haki.." aria-label="First name" required>
        </div>

        <div class="col-md-6">
            <label for="phone" class="form-label">Phone</label>
          <input id="phone" value=" <?php  if(isset($_GET['id'])){
               echo $phone; 
              }  ?> " name="Tel" type="text" class="form-control" placeholder="0641725930" aria-label="phone" required>
        </div>
        ...
        <input type="hidden" name="id" value=" <?php if(isset($_GET['id'])) { echo $_GET['id']; } ?> ">  
         ...
         <div class="col-md-6">
          ...
          <input id="City"   value=" <?php  if(isset($_GET['id'])){
               echo $adresse; 
              }  ?> "  name="Adress"   type="text" class="form-control" placeholder="adresse" aria-label="City" required>
        </div>

        <div class="col-md-6">
          <label for="Email" class="form-label">Email</label>
        <input id="Email"  value=" <?php  if(isset($_GET['id'])){
               echo $email; 
              }  ?> " type="Email"  name="Email" class="form-control" placeholder="Mohamedhaki123@gmail.com" aria-label="Email" required>
      </div>
          ...
          <div class="col-12">
            <button type="submit" name="OK" class="btn btn-primary"><?php  
            if(isset($_GET['id'])){
               echo "Update Changes"; 
              } 
              else {
